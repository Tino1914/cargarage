...
public class ClientControllerTest {
    ...
    Client [] clients = new Client[]{new Client().setFirstName("Ivan").setLastName("Cho").setPassword("1244").setClientIdentifier("2").setPhone("2121415").setUserName("vanko"),new Client().setFirstName("Ivan").setLastName("Cho").setPassword("1244").setClientIdentifier("2").setPhone("2121415").setUserName("vanko")};
